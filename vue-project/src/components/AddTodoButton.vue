<template>
  <button type="button" class="btn btn-primary" @click="modal.show()">Add
    todo</button>
...
title`" v-model="title" />
            ...
            <div class="mb-2">
              ...
              <label :for="`${id}-date`" class="form-label">Done
                by</label>
...
date`" v-model="date" />
            ...
            <div class="mb-2">
              ...
              <label :for="`${id}-description`" class="form-
